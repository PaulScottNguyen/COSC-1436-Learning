...
int main()
{
	...
	int ValueN2 = N2;
    /*3. Compute the sum of N1 and N2, store it in a variable called Sum,
	 print the message "The sum of N1 and N2 is ValueSum"
    */

    //Allocate Sum, Assign Sum & COMPUTE N1+N2=ValueSum
    int Sum = N1 + N2;
    //OUTPUT
